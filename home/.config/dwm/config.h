...
static const char *fonts[]            = { "Meslo LGS Nerd Font Mono:size=20:bold", "NotoColorEmoji:size=20:bold", "monospace:size=20" };
...
static const Key keys[] = {
  ...
  // ▀▄▀▄▀ █ █░▀█ █▄▀ █▄█ ▀▄▀▄▀   █░▀░█ █▀█ █░▀█ █▀█ █▄█ ██▄ █░▀░█ ██▄ █░▀█ ░█░
    ...
    { SUPER,                        XK_Left,   setmfact,       {.f = -0.001} }, //Resize window to the left
    { SUPER,                        XK_Right,  setmfact,       {.f = +0.001} }, //Resize window to the right
