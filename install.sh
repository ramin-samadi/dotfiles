#!/bin/bash
sudo pacman -Syu wget git pamixer playerctl firefox unzip vim xorg nodejs tldr lsd flatpak ncdu btop bash-completion traceroute tree trash-cli cronie vi nvim linux-headers electron
