...
paru -Syu appimagelauncher dust bitwarden authy nmap whois calcurse spotify rustdesk-bin motrix-bin amdguid-glow-bin vulkan-amdgpu-pro lib32-vulkan-amdgpu-pro
